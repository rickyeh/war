...
function draw() {
    ...
    outputP1.innerHTML = "<img src=images/cards/" + getCardName(playerOneCurrentCard) + ">";

    console.log("Player Two draws a card.");
    console.log(playerTwoCurrentCard);
    outputP2.innerHTML = "<img src=images/cards/" + getCardName(playerTwoCurrentCard) + ">";
...
function preloadImages() {
    ...
    for (var i = 0; i < arrayOfValues.length; i++) {
        for (var j = 0; j < arrayOfSuits.length; j++) {
            arrayOfDeck.push("images/cards/" + arrayOfValues[i] + arrayOfSuits[j] + ".png");
        }
    }
